...
const articleInfo = [
  {
    ...
    description:
      'Artificial intelligence is rnpm list @mui/materialevolutionizing software engineering. Explore how AI-driven tools are enhancing development processes and improving software quality.',
    authors: [
